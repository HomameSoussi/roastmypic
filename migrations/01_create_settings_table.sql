-- Create the platform_settings table to store dynamic configurations
...
-- Insert default values for all the new configurable settings
...
-- Create a trigger to call the function before any update on the platform_settings table
